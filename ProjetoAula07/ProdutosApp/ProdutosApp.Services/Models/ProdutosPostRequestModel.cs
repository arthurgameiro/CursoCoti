...
{
    /// <summary>
    /// Modelo de dados para a requisição POST de cadastro de produtos
    /// </summary>
    public class ProdutosPostRequestModel
    {
        [RegularExpression("^[A-Za-zÀ-Üà-ü0-9\\s]{8,100}$",
            ErrorMessage = "Por favor, informe um nome válido de 8 a 100 caracteres.")]
